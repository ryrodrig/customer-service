...
import com.cfgtest.services.customerservice.model.ErrorDetailsErrorDetails;
...
//    @ResponseStatus(code = HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<ErrorDetails> handleCustomerServiceException(CustomerServiceException cse) {
